...
parser.add_argument('--task', type=str, choices=['task_1_tumor_vs_normal', 'task_2_tumor_subtyping','custom','custom_998','custom_912','custom_827','custom_912_aug','custom_20','nsclc'])
...
elif args.task == 'custom_912': ## The above 998 WSIs with biopsies removed, leaving only resections
    args.n_classes=5
...
elif args.task == 'custom_827': ## The above 998 WSIs with biopsies removed, leaving only resections
    args.n_classes=5
    dataset =  Generic_WSI_Classification_Dataset(csv_path = 'dataset_csv/set_all_827.csv',
                            shuffle = False,
                            seed = args.seed,
                            print_info = True,
                            label_dict = {'high_grade':0,'low_grade':1,'clear_cell':2,'endometrioid':3,'mucinous':4},
