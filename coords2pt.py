...
destination='../mount_outputs/treatment_coords'
...
for i,slide_id in enumerate(df['slide_id']):
    ...
    file_path = os.path.join("../mount_i/features/treatment_features_256_patches_10x_updated",'h5_files','{}.h5'.format(slide_id))
